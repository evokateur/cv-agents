...
\begin{center}
\fcolorbox{white}{blue!10}{\parbox{0.95\textwidth}{
    \centering (( '{\\LARGE\\textbf{' ~ name  ~ '}}' )) \\
    (( contact.city )), (( contact.state )) \textbar\ (( contact.phone )) \textbar\ (( '\\href{mailto:' ~ contact.email ~ '}{' ~ contact.email ~'}' )) 

    (( '\\href{https://' ~ contact.linkedin ~ '}{' ~ contact.linkedin ~ '}' )) \textbar\ (( '\\href{https://' ~ contact.github ~ '}{' ~ contact.github ~ '}' )) 
}}
\end{center}
